...
from data_loading_img import list_beatmap_files_from_ds, process_path3
...
checkpoint_filepath = "saved_models/sdf_osu_5.pth"
...
num_val = 5
val_ds = list(list_beatmap_files_from_ds().skip(19).interleave(process_path3, cycle_length=num_val).skip(100).batch(num_val).take(1))[0]
val_preds = []
with torch.no_grad():
    for img in val_ds[0]:
